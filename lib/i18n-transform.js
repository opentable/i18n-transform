...
var _getLanguageFromI18n = function (i18nObj) {
    ...
    _isLanguageCodeMatch = function (a, b) {
        return a.code.toUpperCase() === b.code.toUpperCase();
    },

    _isLanguageRegionMatch = function (a, b) {
        return (a.region === undefined || b.region === undefined) ||
            a.region.toUpperCase() === b.region.toUpperCase();
    },

    _isLanguageMatch = function (a, b) {
        return _isLanguageCodeMatch(a, b) && _isLanguageRegionMatch(a, b);
    },

    _parseLanguageCode = function (language) {
        if (language) {
    ...
    _getSelectedLanguage = function (source, i18nArray, acceptLanguages, fields) {
        var primaryLanguage = _parseLanguageCode(source.PrimaryLanguage);
